  ...
  return (
    <section className='weatherCard'>
      ...
      <ul className='weatherCard__list'>
        ...
        <li className='wheather_description'><span>Wind Speed:</span> {weather?.wind.speed} m/sec</li>
        <li className='wheather_description'><span>Clouds:</span> {weather?.clouds.all} %</li>
        <li className='wheather_description'><span>Pressure:</span> {weather?.main.pressure} hPa</li>
      </ul>
